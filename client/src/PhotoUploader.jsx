  ...
  return (
    <>
      ...
      <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
        {addedPhotos.length > 0 &&
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              <img
                className="rounded-2xl w-full obj-cover"
        ...
        <label className="h-32 cursor-pointer items-center border bg-transparent rounded-2xl p-2 text-2xl text-gray-600 flex justify-center gap-1">
          <input
            type="file"
            multiple
            className="hidden"
